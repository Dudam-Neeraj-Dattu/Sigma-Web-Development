      ...
      <div className="flex justify-center m-auto w-[80%] mt-7 mb-10 ">
         ...
         {passwords.length === 0 ? (
            ...
            <div className="grid grid-cols-6 w-3/4">
               {/* Header */}
               <div className="bg-green-200 text-green-900 py-2 px-4 font-bold border-2 border-r-2 border-green-400 rounded-tl-lg sticky top-15.5 z-10 col-span-3 break-all">Website URL</div>
